...
AI assistance features are available within the note editor. Free tier users can access basic AI autocomplete, while pro tier users have access to advanced features like text summarization and translation.
